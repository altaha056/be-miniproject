...
func (_m *Business) Downvote(articleId int, userId int) error {
...
func (_m *Business) Rating(userId int) ([]appreciate.ArticleCore, error) {
...
func (_m *Business) Upvote(articleId int, userId int) error {
	ret := _m.Called(articleId, userId)
...
func (_m *Business) WhoVote(articleId int) ([]appreciate.UserCore, error) {
